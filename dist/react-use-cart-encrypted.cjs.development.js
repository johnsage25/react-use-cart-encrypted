...
var SecureLS = /*#__PURE__*/require('secure-ls');
...
function useLocalStorage(key, initialValue) {
  var _React$useState = React.useState(function () {
    try {
      var ls = new SecureLS({
        encodingType: 'aes',
        encryptionSecret: 'pJs(?&4Zyp6dbA`(Qh&s&8]s94C<Lx<H#&Vk5#cn3ttfexeHHv6W#/LW(3v4r8UkE!Cy92]Kf'
      });
      var item = typeof ls !== "undefined" && ls.get(key);
...
var CartProvider = function CartProvider(_ref) {
  ...
  var _storage = storage(cartId ? "react-use-cart-" + id : "react-use-cart-encrypted", JSON.stringify(_extends({
    id: id
  }, initialState, {
    items: defaultItems,
    metadata: metadata
...
//# sourceMappingURL=react-use-cart-encrypted.cjs.development.js.map
